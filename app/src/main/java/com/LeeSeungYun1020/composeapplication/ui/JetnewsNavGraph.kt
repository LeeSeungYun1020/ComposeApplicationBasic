...
import com.LeeSeungYun1020.composeapplication.data.AppContainer
import com.LeeSeungYun1020.composeapplication.ui.MainDestinations.ARTICLE_ID_KEY
import com.LeeSeungYun1020.composeapplication.ui.article.ArticleScreen
import com.LeeSeungYun1020.composeapplication.ui.home.HomeScreen
import com.LeeSeungYun1020.composeapplication.ui.interests.InterestsScreen
...
fun JetnewsNavGraph(
    ...
    NavHost(
        ...
        composable(MainDestinations.INTERESTS_ROUTE) {
            InterestsScreen(
                interestsRepository = appContainer.interestsRepository, openDrawer = openDrawer
            )
        }
