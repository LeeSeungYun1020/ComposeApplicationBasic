...
package com.LeeSeungYun1020.composeapplication.data.posts

import com.LeeSeungYun1020.composeapplication.R
import com.LeeSeungYun1020.composeapplication.model.*
...
val publication = Publication(
    "Android Developers", "https://cdn-images-1.medium.com/max/258/1*u7oZc2_5mrkcFaxkXEyfYA@2x.png"
)
val paragraphsPost1 = listOf(
    Paragraph(
        ...
        ParagraphType.Text, "These modules are included in the settings.gradle file as:"
    ), Paragraph(
    ...
    Paragraph(
        ...
        ParagraphType.Text, "And the layout in Android Studio is now:"
    ), Paragraph(
        ParagraphType.Header, "Conclusion"
    ), Paragraph(
        ParagraphType.Text,
        ...
        ParagraphType.Header, "Resources"
    ), Paragraph(
        ParagraphType.Bullet, "Android Studio: Tips and Tricks (Google I/O’19)", listOf(
            Markup(
                MarkupType.Link,
                0,
                47,
    ...
    Paragraph(
        ParagraphType.Bullet, "On Demand module codelab", listOf(
            Markup(
                MarkupType.Link,
                0,
                24,
        ...
        ParagraphType.Bullet, "Patchwork Plaid — A modularization story", listOf(
            Markup(
                MarkupType.Link,
                0,
                40,
...
val paragraphsPost2 = listOf(
    Paragraph(
        ...
        listOf(
            Markup(
                MarkupType.Link, 0, 6, "https://dagger.dev/"
            )
        )
    ), Paragraph(
        ParagraphType.Text,
        ...
        listOf(
            Markup(
                MarkupType.Link, 14, 26, "https://dagger.dev/tutorial/"
            ),
        ...
        listOf(
            Markup(
                MarkupType.Link, 58, 70, "https://github.com/google/dagger/issues/900"
            )
        )
    ), Paragraph(
        ParagraphType.Header, "kapt build improvements"
    ), Paragraph(
        ParagraphType.Text,
        ...
        listOf(
            Markup(
                MarkupType.Link, 92, 97, "https://github.com/google/dagger/releases/tag/dagger-2.18"
            ), Markup(
                MarkupType.Link,
                165,
                170,
        ...
        ParagraphType.Text, "Qualifiers for field attributes"
    ), Paragraph(
        ParagraphType.Text, "", listOf(Markup(MarkupType.Link, 0, 0))
    ), Paragraph(
        ParagraphType.Text,
        ...
        listOf(
            Markup(MarkupType.Code, 181, 187), Markup(
                MarkupType.Link,
                268,
                285,
                "http://frogermcs.github.io/dependency-injection-with-dagger-2-custom-scopes/"
            ), Markup(MarkupType.Italic, 114, 119), Markup(MarkupType.Italic, 143, 149)
        )
    ), Paragraph(
        ParagraphType.Text, "✅ The way to apply qualifiers on an injected field is:"
    ), Paragraph(
        ParagraphType.CodeBlock,
        "@Inject @field:MinimumBalance lateinit var minimumBalance: BigDecimal",
        listOf(Markup(MarkupType.Bold, 8, 29))
    ), Paragraph(
        ParagraphType.Text, "❌ As opposed to:"
    ), Paragraph(
        ParagraphType.CodeBlock, """
        @Inject @MinimumBalance lateinit var minimumBalance: BigDecimal 
        // @MinimumBalance is ignored!
        """.trimIndent(), listOf(Markup(MarkupType.Bold, 65, 95))
    ), Paragraph(
        ParagraphType.Text,
        ...
        ParagraphType.Header, "Injecting Generics"
    ), Paragraph(
        ParagraphType.Text,
        ...
        listOf(
            Markup(MarkupType.Code, 184, 193), Markup(MarkupType.Code, 216, 233), Markup(
                MarkupType.Link,
                132,
                146,
        ...
        listOf(
            Markup(MarkupType.Code, 95, 116), Markup(
                MarkupType.Link, 66, 75, "https://en.wikipedia.org/wiki/Class_invariant"
            ), Markup(
                MarkupType.Link,
                96,
                116,
        ...
        listOf(
            Markup(
                MarkupType.Link, 57, 86, "https://dagger.dev/multibindings.html"
            )
        )
    ), Paragraph(
        ParagraphType.CodeBlock, """
        ...
        """.trimIndent(), listOf(Markup(MarkupType.Bold, 72, 93))
    ), Paragraph(
        ParagraphType.Header, "Inline method bodies"
    ), Paragraph(
        ParagraphType.Text,
...
val paragraphsPost3 = listOf(
    Paragraph(
        ...
        listOf(
            Markup(MarkupType.Code, 245, 251), Markup(MarkupType.Code, 359, 365), Markup(
                MarkupType.Link,
                4,
                25,
                "https://codelabs.developers.google.com/codelabs/java-to-kotlin/#0"
...
val paragraphsPost4 = listOf(
    Paragraph(
        ...
        listOf(
            Markup(
                MarkupType.Link, 61, 103, "https://issuetracker.google.com/issues/111961971"
        ...
        listOf(
            Markup(
                MarkupType.Link, 3, 9, "https://twitter.com/ZelenetS"
            ), Markup(
                MarkupType.Link, 28, 36, "https://issuetracker.google.com/issues/111961971#comment2"
...
val paragraphsPost5 = listOf(
    Paragraph(
        ...
        listOf(
            Markup(MarkupType.Code, 222, 225), Markup(MarkupType.Code, 312, 320), Markup(
                MarkupType.Link,
                222,
                225,
        ...
        listOf(
            Markup(MarkupType.Code, 27, 32), Markup(
                MarkupType.Link,
                27,
                32,
        ...
        ParagraphType.Header, "Collections and sequences"
    ), Paragraph(
        ParagraphType.Text,
        ...
        ParagraphType.Subhead, "Collections"
    ), Paragraph(
        ParagraphType.Text,
        ...
        ParagraphType.Subhead, "Sequences"
    ), Paragraph(
    ...
    Paragraph(
        ...
        ParagraphType.Header, "Performance"
    ), Paragraph(
        ParagraphType.Subhead, "Order of transformations"
    ), Paragraph(
        ParagraphType.Text,
...
val post1 = Post(
    ...
    metadata = Metadata(
        author = pietro, date = "August 02", readTimeMinutes = 1
    ),
...
val post2 = Post(
    ...
    publication = publication,
    metadata = Metadata(
        author = manuel, date = "July 30", readTimeMinutes = 3
    ),
...
val post3 = Post(
    ...
    publication = publication,
    metadata = Metadata(
        author = florina, date = "July 09", readTimeMinutes = 1
    ),
...
val post4 = Post(
    ...
    publication = publication,
    metadata = Metadata(
        author = jose, date = "April 02", readTimeMinutes = 1
    ),
...
val post5 = Post(
    ...
    publication = publication,
    metadata = Metadata(
        author = florina, date = "July 24", readTimeMinutes = 4
    ),
